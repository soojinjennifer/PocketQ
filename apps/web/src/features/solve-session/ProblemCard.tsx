 ...
 *
 * 과거에는 결과 화면 "수정"(다시 입력) 흐름의 재촬영 안내용 `{ needsRetake: true }` 상태도
 * 있었지만, "수정"이 `/solve/pencilcanvas` WORK 화면으로 돌아가는 흐름으로 바뀌면서(2026-09,
 * `SolveLandscapePage`의 "수정" 흐름 JSDoc 참고) 이 컴포넌트에서 완전히 제거됐다.
 */
